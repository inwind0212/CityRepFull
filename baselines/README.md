...
- Kaggle stores the embedding bytes under `embeddings/<model>/` in 11 model directories.
- `bash download.sh` restores them to the relative `baselines/artifacts/` paths recorded in the manifest.
